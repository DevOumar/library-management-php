...
$cone=$dbh->query("UPDATE tblstudents set message='$message' where StudentId='$id' ");
if ($cone) {
  # code...

$_SESSION['msg']="Votre témoignage est ajouté avec succès !";
}

else {
  $_SESSION['error']="Votre témoignage n'est pas ajouté, veuillez réessayer !";  
}
}
...
<title>BIBLIOTHEQUE | TEMOIGNAGE </title>
        ...
        <div class="col-lg-12">
          <div class="card card-outline">
            <div class="card-header bg-primary">
              <h5 class="text-white m-b-0">Témoignage</h5>
            </div>
...
<?php } ?>      
 ...
 <div class=" col-lg-6">
    <label for="exampleFormControlTextarea1">Message de témoignage</label>
    <textarea class="form-control h4" required="required" name="message" id="exampleFormControlTextarea1" rows="3"></textarea>
  </div>



 <button type="submit" name="change" class="btn btn-primary">Envoyer</button> 
</form>
 </div>
</div>
</div>
