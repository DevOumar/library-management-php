...
{
$csr=$_POST['csr'];
$query=$dbh->query("SELECT * from casier where casier='$csr'");
$requ=$query->rowcount();
if ($requ==1){
  $_SESSION['error']="Casier déjà ajouté !";
header('location:gestion-casier');
}else{
$sql="INSERT INTO  casier(casier) VALUES(:csr)";
...
if($lastInsertId)
{
$_SESSION['msg']="Casier ajouté avec succès !";
header('location:gestion-casier');
}
else 
{
        ...
        <div class="col-lg-12">
          <div class="card card-outline">
            <div class="card-header bg-primary">
              <h5 class="text-white m-b-0">Ajouter Casier</h5>
            </div>
             <div class="card-body">
              <form role="form" method="post">
              <div class="form-group">
                <label>Numéro de casier</label>
               <input class="form-control" type="text" name="csr" autocomplete="on"  required />
              </div>
