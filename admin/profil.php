...
if(isset($_GET['accepte-cookie'])){
  ...
  {      
    ...
    $sql="UPDATE admin set updationDate=:updationdate,FullName=:fname,AdminEmail=:adminemail where UserName='$_SESSION[alogin]' ";
      ...
      <div class="card card-outline">
        ...
        <div class="card-body">
          <form role="form" method="post" enctype="multipart/form-data">
            ...
            $sql="SELECT FullName,updationDate,AdminEmail from admin where UserName='$_SESSION[alogin]'";
            $query = $dbh -> prepare($sql);
        ...
        <div class="form-group">
          ...
          <input class="form-control" type="email" name="adminemail" id="adminemail" value="<?php echo htmlentities($result->AdminEmail);?>"  autocomplete="off" required />
        </div>    
  <?php }} ?>
  <button type="submit" name="update" class="btn btn-primary" id="submit">Mettre à jour </button>
</form>
</div>
</div>
</div>
  ...
  <?php
       if (isset($_POST["update"])) {
        ...
        move_uploaded_file($_FILES["image"]["tmp_name"],$imagepath);
         $sql=$dbh->query("UPDATE admin SET Photo='".$imagepath."' WHERE UserName='".$_SESSION['alogin']."'");
