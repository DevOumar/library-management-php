...
<div class="panel-body">
  <div class="info-box">
    <h4><marquee>Bienvenue <?php echo $_SESSION['alogin']; ?> dans la Bibliothèque de INTEC SUP. Cette Bibliothèque est ouverte de 8h00 à 19h00. Nous sommes le :
      <?php
  ...
  echo strftime('%A %d %B %Y à %H:%M:%S') ; ?> . </marquee></h4>
       ...
       <div class="col-lg-3 col-sm-6 col-xs-12">
        <a href="gestion-emprunt-livre">
          <div class="info-box bg-green"> <span class="info-box-icon bg-transparent"><i class="fa fa-book text-white"></i></span>
            <div class="info-box-content">
              <h6 class="info-box-text text-white">Total Livres empruntés</h6>
              <h1 class="text-white">
                <?php 
        ...
        <a href="gestion-emprunt-livre"><span class="progress-description  text-white">Total Livres empruntés</span></a></div>
        </a>
            <!-- /.info-box-content --> 
          </div>
          </div>
    <div class="col-lg-3 col-sm-6 col-xs-12">
      <a href="total-livres-retournes">
          <div class="info-box bg-aqua"> <span class="info-box-icon bg-transparent"><i class="fa fa-recycle text-white"></i></span>
            <div class="info-box-content">
              <h6 class="info-box-text text-white">Total Livres retournés</h6>
              <h1 class="text-white">
        <?php 
        $status=1;
    ...
    <a href="total-livres-retournes"><span class="progress-description text-white">Total Livres retournés</span></a></div>
    </a>
            <!-- /.info-box-content -->
      </div>
    </div>
    <div class="col-lg-3 col-sm-6 col-xs-12">
      <a href="liste-etudiant">
          <div class="info-box bg-orange"> <span class="info-box-icon bg-transparent"><i class="fa fa-user text-white"></i></span>
            <div class="info-box-content">
              <h6 class="info-box-text text-white">Nombre d'étudiants</h6>
              <h1 class="text-white">
        <?php 
      ...
      <a href="liste-etudiant"><span class="progress-description text-white">Nombre d'étudiants</span></a></div>
      </a>
            <!-- /.info-box-content -->
      </div>
    </div>
    ...
    <div class="col-lg-3 col-sm-6 col-xs-12">
      <a href="gestion-ranger">
          <div class="info-box bg-aqua"> <span class="info-box-icon bg-transparent"><i class="fa fa-spinner text-white"></i></span>
            <div class="info-box-content">
              <h6 class="info-box-text text-white">Total Rangées</h6>
              <h1 class="text-white">
        <?php 
      ...
      <a href="gestion-ranger"><span class="progress-description text-white">Total Rangées</span></a></div>
      </a>
            <!-- /.info-box-content -->
      </div>
    </div>
  ...
  <div class="col-lg-3 col-sm-6 col-xs-12">
    <a href="gestion-categorie">
          <div class="info-box bg-red"> <span class="info-box-icon bg-transparent"><i class="fa fa-bullseye text-white"></i></span>
            <div class="info-box-content">
              <h6 class="info-box-text text-white">Total Catégories</h6>
              <h1 class="text-white">
      <?php 
    ...
    <?php echo htmlentities($listdcats);?>
     ...
     <a href="gestion-categorie"><span class="progress-description text-white">Total Catégories</span></a></div>
     </a>
            <!-- /.info-box-content -->
    </div>
  </div>
      ...
      <div class="col-lg-7 col-xlg-9">
          <div class="info-box">
            <div class="d-flex flex-wrap">
              <div>
                <h4 class="text-black">Nombre de livres empruntés et retournés par mois et l'année</h4>
                <center>
                <form method="post">

                  <select name="annee">
  <option class="form-control" value="">Séléctionner l'année</option>
  <?php 
...
var chart = new Chart(ctx, {
    ...
    <?php echo htmlentities($listdcats);?>, <?php 
      $sql5 ="SELECT * from tblissuedbookdetails where Mois= 'Février' AND Annee='$annee' ";
      $query5 = $dbh -> prepare($sql5);
      $query5->execute();
      $results5=$query5->fetchAll(PDO::FETCH_OBJ);
      $listdcats=$query5->rowCount();
    ...
    <?php echo htmlentities($listdcats);?>,<?php 
      ...
      ?>
    <?php echo htmlentities($listdcats);?>, <?php 
      $sql5 ="SELECT * from tblissuedbookdetails where Mois= 'Août' AND Annee='$annee' ";
      $query5 = $dbh -> prepare($sql5);
      $query5->execute();
      $results5=$query5->fetchAll(PDO::FETCH_OBJ);
      $listdcats=$query5->rowCount();
    ...
    <?php echo htmlentities($listdcats);?>,<?php 
      ...
      ?>
    <?php echo htmlentities($listdcats);?>,<?php 
      $sql5 ="SELECT * from tblissuedbookdetails where Mois= 'Décembre' AND Annee='$annee' ";
      $query5 = $dbh -> prepare($sql5);
      $query5->execute();
      $results5=$query5->fetchAll(PDO::FETCH_OBJ);
      $listdcats=$query5->rowCount();
    ...
    <?php echo htmlentities($listdcats);?>],
      ...
      ?>
    <?php echo htmlentities($listdcats);?>, <?php 
      $sql5 ="SELECT * from tblissuedbookdetails where RetrunStatus='1' AND Mois='Février' AND Annee='$annee' ";
      $query5 = $dbh -> prepare($sql5);
      $query2->bindParam(':status',$status,PDO::PARAM_STR);
      $query5->execute();
      $results5=$query5->fetchAll(PDO::FETCH_OBJ);
    ...
    <?php echo htmlentities($listdcats);?>, <?php 
      ...
      ?>
    <?php echo htmlentities($listdcats);?>,<?php 
      $sql5 ="SELECT * from tblissuedbookdetails where RetrunStatus='1' AND Mois='Août' AND Annee='$annee' ";
      $query5 = $dbh -> prepare($sql5);
      $query2->bindParam(':status',$status,PDO::PARAM_STR);
      $query5->execute();
      $results5=$query5->fetchAll(PDO::FETCH_OBJ);
    ...
    <?php echo htmlentities($listdcats);?>, <?php 
      ...
      ?>
    <?php echo htmlentities($listdcats);?>, <?php 
      $sql5 ="SELECT * from tblissuedbookdetails where RetrunStatus='1' AND Mois='Décembre' AND Annee='$annee' ";
      $query5 = $dbh -> prepare($sql5);
      $query2->bindParam(':status',$status,PDO::PARAM_STR);
      $query5->execute();
      $results5=$query5->fetchAll(PDO::FETCH_OBJ);
