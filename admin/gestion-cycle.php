...
<div class="panel-body">
  <div class="info-box">
    <h4 class="text-black"><i class="fa fa-spinner"></i> Cycles(<?php 
        $sql3 ="SELECT id from cycle ";
        $query3 = $dbh -> prepare($sql3);
        $query3->execute();
        $results3=$query3->fetchAll(PDO::FETCH_OBJ);
        $regstds=$query3->rowCount();
        ?><?php echo htmlentities($regstds);?>) <a href="ajouter-cycle" class="btn btn-primary btn-sm"><i class="fa fa-plus-circle"></i> Nouveau</a></h4>
    <hr />
        ...
        $update_date=date('d-m-Y à H:i:s',$format_update_date);               
          ?>                                      
            <tr class="odd gradeX">
              ...
              <td><span class="label label-success"><?php echo htmlentities($result->Nom_cycle);?></span></td>
             <td><span class="label label-warning"><?php echo htmlentities($date);?></span></td>
              ...
              <td class="center">
                ...
                <a href="modifier-cycle?cylid=<?php echo htmlentities($result->id);?>"><i title="Modifier" class="fa fa-edit"></i></a>
        <a class="delete" href="gestion-cycle?del=<?php echo htmlentities($result->id);?>" data-id="<?php echo htmlentities($result->id);?>"><i title="Supprimer" class="fa fa-trash"></i></a>
                  <p class="result"></p>
                  </td>
                </tr>
                <?php $cnt=$cnt+1;}} ?>                                      
...
$('.changeStat').click(function (e) {
    ...
    swal({
                  title: 'Êtes-vous sûr ?',
                  text: 'Changer le statut de cete Campagne !',
                  type: 'warning',
                  showCancelButton: true,
                  confirmButtonColor: '#DD6B55',
