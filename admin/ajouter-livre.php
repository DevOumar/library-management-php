...
{   
  ...
  if(isset($_POST['add']))
  {
    ...
    $query=$dbh->query("SELECT * from tblbooks where ISBNNumber='$isbn'");
    $requ=$query->rowcount();
    if ($requ==1){
      $_SESSION['error']="Livre déjà ajouté !";
      header('location:gestion-livre');
    }else{
      $sql="INSERT INTO  tblbooks(BookName,CatId,AuthorId,ISBNNumber,Casier,Ranger,Nbre_page) VALUES(:bookname,:category,:author,:isbn,:casier, :ranger,:nbre_page)";
      ...
      if($lastInsertId)
      {
        $_SESSION['msg']="Livre ajouté avec succès !";
        header('location:gestion-livre');
      }
    ...
    <div class="col-lg-12">
      <div class="card card-outline">
        <div class="card-header bg-primary">
          <h5 class="text-white m-b-0">Ajouter Livres</h5>
        </div>
        <div class="card-body">
            ...
            <div class="form-group">
              ...
              <input class="form-control" type="text" name="nbre_page" autocomplete="off"  required />
                                ...
                                <div class="form-group">
                                  ...
                                  <p class="help-block">Un ISBN est un numéro international normalisé de livre. L'ISBN doit être unique.</p>
                                </div>
