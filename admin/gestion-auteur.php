...
<div class="panel-body">
  <div class="info-box">
    <h4 class="text-black"><i class="fa fa-user"></i> Auteurs(<?php 
      $sql4 ="SELECT id from tblauthors ";
      $query4 = $dbh -> prepare($sql4);
      $query4->execute();
      $results4=$query4->fetchAll(PDO::FETCH_OBJ);
      $listdathrs=$query4->rowCount();
      ?><?php echo htmlentities($listdathrs);?>) <a href="ajouter-auteur" class="btn btn-primary btn-sm"><i class="fa fa-plus-circle"></i> Nouveau</a></h4>
    <hr />
    ...
    <tbody>
      ...
      if($query->rowCount() > 0)
      {
        foreach($results as $result)
          {
            $recup_date=$result->creationDate;
        ...
        $update_date=date('d-m-Y à H:i:s',$format_update_date);
            ...
            <tr class="odd gradeX">
              ...
              <td class="center">
                ...
                <a href="modifier-auteur?athrid=<?php echo htmlentities($result->id);?>"><i title="Modifier" class="fa fa-edit"></i></a>
                  <a class="delete" href="gestion-auteur?del=<?php echo htmlentities($result->id);?>" data-id="<?php echo htmlentities($result->id);?>"><i title="Supprimer" class="fa fa-trash"></i></a>
                  </td>
                </tr>
                <?php $cnt=$cnt+1;}} ?>                                      
              </tbody>
