...
<div class="panel-body">
  <div class="info-box">
    <h4 class="text-black">Liste des mémoires soutenus <a href="ajouter-memoire" class="btn btn-primary btn-sm"><i class="fa fa-plus-circle"></i> Nouveau</a></h4>
    <hr />
  ...
  ?>                                    
            ...
            <td class="center"><?php echo htmlentities($result->CategoryName);?></td>
              ...
              <td class="center">
                ...
                <a href="modifier-memoire?memoid=<?php echo htmlentities($result->memoid);?>"><i title="Modifier" class="fa fa-edit"></i></a> 
                  <a href="gestion-memoire?del=<?php echo htmlentities($result->memoid);?>" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cet élément?');"><i title="Supprimer" class="fa fa-trash"></i></a>
                 </td>
                </tr>
                <?php $cnt=$cnt+1;}}?>                                      
              </tbody>
