...
$query=$dbh->query("SELECT * from annee where libelle='$annee_emprunt'");
$requ=$query->rowcount();
if ($requ==1){
  $_SESSION['error']="Année déjà ajoutée !";
header('location:gestion-annee');
}else{
$sql="INSERT INTO  annee(libelle) VALUES(:annee_emprunt)";
...
if($lastInsertId)
{
$_SESSION['msg']="Année ajoutée avec succès !";
header('location:gestion-annee');
}
else 
{
        ...
        <div class="col-lg-12">
          <div class="card card-outline">
            <div class="card-header bg-primary">
              <h5 class="text-white m-b-0">Ajouter Année</h5>
            </div>
             <div class="card-body">
              <form role="form" method="post">
              <div class="form-group">
                <label>Année</label>
               <input class="form-control" type="text" name="annee_emprunt" autocomplete="on"  required />
              </div>
