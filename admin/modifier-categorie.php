...
$query->execute();
$_SESSION['updatemsg']="Catégorie mise à jour avec succès !";
        ...
        <div class="col-lg-12">
          <div class="card card-outline">
            <div class="card-header bg-primary">
              <h5 class="text-white m-b-0">Modifier Catégorie</h5>
            </div>
...
<div class="radio">
<label>
<input type="radio" name="status" id="status" value="0" checked="checked">Désactivé
</label>
</div>
 <div class="radio">
<label>
<input type="radio" name="status" id="status" value="1">Activé
</label>
</div>
<?php } ?>
</div>
