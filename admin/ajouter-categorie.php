...
$Status=$_POST['Status'];
$query=$dbh->query("SELECT * from tblcategory  
  where CategoryName='$CategoryName'");
$requ=$query->rowcount();
if ($requ==1){
  $_SESSION['error']="Catégorie déjà ajoutée !";
header('location:gestion-categorie');
}else{
$sql=$dbh->prepare("INSERT INTO  tblcategory(CategoryName,Status) VALUES(?,?)");
if ($sql->execute(array($_POST['CategoryName'],$_POST['Status'])) ) {
  
$_SESSION['msg']="Catégorie ajoutée avec succès !";
header('location:gestion-categorie');
}
else 
{
        ...
        <div class="col-lg-12">
          <div class="card card-outline">
            <div class="card-header bg-primary">
              <h5 class="text-white m-b-0">Ajouter Catégorie</h5>
            </div>
             <div class="card-body">
...
<div class="radio">
<label>
<input type="radio" name="Status" id="status" value="0">Désactivé
</label>
</div>
