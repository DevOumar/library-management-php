...
if(isset($_GET['accepte-cookie'])){
  ...
  <head>
    ...
    <title>BIBLIOTHEQUE | ANNEE </title>
...
<div class="panel-body">
  <div class="info-box">
    <h4 class="text-black"><i class="fa fa-table"></i> Années(<?php 
        $sql3 ="SELECT id from annee ";
        $query3 = $dbh -> prepare($sql3);
        $query3->execute();
        $results3=$query3->fetchAll(PDO::FETCH_OBJ);
        $regstds=$query3->rowCount();
        ?><?php echo htmlentities($regstds);?>) <a href="ajouter-annee" class="btn btn-primary btn-sm"><i class="fa fa-plus-circle"></i> Nouveau</a></h4>
    <hr />
           ...
           ?>                                      
            <tr class="odd gradeX">
              ...
              <td class="center">
                ...
                <a href="modifier-annee?anneeid=<?php echo htmlentities($result->id);?>"><i title="Modifier" class="fa fa-edit"></i></a> 
                  <a class="delete" href="gestion-annee?del=<?php echo htmlentities($result->id);?>" data-id="<?php echo htmlentities($result->id);?>"><i title="Supprimer" class="fa fa-trash"></i></a>
