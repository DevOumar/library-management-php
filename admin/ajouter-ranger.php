...
{
$rng=$_POST['rng'];
$query=$dbh->query("SELECT * from ranger where ranger='$rng'");
$requ=$query->rowcount();
if ($requ==1){
  $_SESSION['error']="Rangée déjà ajoutée !";
header('location:gestion-ranger');
}else{
$sql="INSERT INTO  ranger(ranger) VALUES(:rng)";
...
if($lastInsertId)
{
$_SESSION['msg']="Rangée ajoutée avec succès !";
header('location:gestion-ranger');
}
else 
{
        ...
        <div class="col-lg-12">
          <div class="card card-outline">
            <div class="card-header bg-primary">
              <h5 class="text-white m-b-0">Ajouter Rangée</h5>
            </div>
             <div class="card-body">
              <form role="form" method="post">
              <div class="form-group">
                <label>Numéro de la rangée</label>
               <input class="form-control" type="text" name="rng" autocomplete="on"  required />
              </div>
