...
<div class="panel-body">
  <div class="info-box">
    <h4 class="text-black"><i class="fa fa-book"></i> Livres(<?php 
        $sql ="SELECT id from tblbooks ";
        $query = $dbh -> prepare($sql);
        $query->execute();
        $results=$query->fetchAll(PDO::FETCH_OBJ);
        $listdbooks=$query->rowCount();
        ?><?php echo htmlentities($listdbooks);?>) <a href="ajouter-livre" class="btn btn-primary btn-sm"><i class="fa fa-plus-circle"></i> Nouveau</a></h4>
    <hr />
...
<div class="table-responsive">
  <table id="dataList" class="table table-bordered table-hover" data-name="cool-table">
    ...
    <tbody>
      <?php $sql = "SELECT tblbooks.BookName,tblbooks.Quantite,tblbooks.Stock,tblbooks.RegDate,tblbooks.Nbre_page,ranger.ranger,casier.casier,tblcategory.CategoryName,tblauthors.AuthorName,tblbooks.ISBNNumber,tblbooks.id AS bookid FROM  tblbooks JOIN tblcategory ON tblcategory.id=tblbooks.CatId JOIN tblauthors ON tblauthors.id=tblbooks.AuthorId
      ...
      if($query->rowCount() > 0)
      {
        ...
        $date=date('d-m-Y',$format);
            ...
            <td class="center"><?php echo htmlentities($result->CategoryName);?></td>
              ...
              <td class="center">
                <a href="modifier-livre?bookid=<?php echo htmlentities($result->bookid);?>"><i title="Modifier" class="fa fa-edit"></i></a> 
                   <a class="delete" href="gestion-livre?del=<?php echo htmlentities($result->bookid);?>" data-id="<?php echo htmlentities($result->bookid);?>"><i title="Supprimer" class="fa fa-trash"></i></a>
                 </td>
                </tr>
                <?php $cnt=$cnt+1;}}?>                                      
              </tbody>
