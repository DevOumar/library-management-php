...
{
$niveau=$_POST['niveau'];
$query=$dbh->query("SELECT * from cycle where Nom_cycle='$niveau'");
$requ=$query->rowcount();
if ($requ==1){
  $_SESSION['error']="Cycle déjà ajouté !";
header('location:gestion-cycle');
}else{
$sql="INSERT INTO  cycle(Nom_cycle) VALUES(:niveau)";
...
if($lastInsertId)
{
$_SESSION['msg']="Cycle ajouté avec succès !";
header('location:gestion-cycle');
}
else 
{
        ...
        <div class="col-lg-12">
          <div class="card card-outline">
            <div class="card-header bg-primary">
              <h5 class="text-white m-b-0">Ajouter Cycle</h5>
            </div>
             <div class="card-body">
              <form role="form" method="post">
              <div class="form-group">
                <label>Nom du cycle</label>
               <input class="form-control" type="text" name="niveau" autocomplete="on"  required />
              </div>
